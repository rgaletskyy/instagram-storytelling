...
- **FR-008j**: When a scene recreates something a supplied video shows, System MUST attach a frame from that video and match its look, rather than imagining the scene from the written description alone.
